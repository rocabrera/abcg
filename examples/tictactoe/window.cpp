...
void Window::onPaintUI() {
  ...
  // LEMBRAR: PROF ta escrito narrowt ao invés de narrow
  // DUVIDA: O que é esse auto const ... estou com dificuldade para entender essa linha
  ...
  // "Tic-Tac-Toe" window
  {
    ...
    // DUVIDA: De onde vem essas flags?
    ...
    // Menu
    {
      ...
      // DUVIDA: Porque tem o if aqui?
      if (ImGui::BeginMenuBar()) {
      // DUVIDA: Porque tem o if aqui também?
