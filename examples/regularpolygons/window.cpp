...
// Duvidas gerais ... 
// Em qual momento é colocado no VBO os vértices? O qual suponho estar na variavel positions 
...
void Window::onCreate() {
  ...
  // https://hbatagelo.github.io/cg/glpipeline.html
  // DUVIDA: Processa cada fragmento individualmente após a rasterização (Processo de mandar de vetor para matriz).
